...
document.querySelector(".cost-input").addEventListener("change", function () {
  ...
  document.querySelector(".calculator-form__amount").innerHTML = Math.round(Number(document.querySelector(".cost-input").value) - Number(document.querySelector(".installment-symm-input").value) * (Number(document.querySelector(".installment-input").value * 100) / (1 + Number(document.querySelector(".installment-input").value * 100) - Number(document.querySelector(".term-input").value)))) + "₽";
...
document.querySelector(".installment-input").addEventListener("change", function () {
  document.querySelector(".installment-symm-input").value = Math.round((document.querySelector(".installment-input").value / 100) * document.querySelector(".cost-input").value)
  if (document.querySelector(".installment-input").value < 10) {
    document.querySelector(".installment-input").value = 10
...
document.addEventListener("click", function (e) {
  ...
  // if (!document.querySelector(".js-validate-error-label")) {
...
const con = document.querySelector(".header");
...
document.querySelector(".input-name").addEventListener("change", function () {
  let length = document.querySelector(".input-name").value.length
  if (length >= 2) {
...
document.querySelector(".input-tel").addEventListener("change", function () {
  let length = document.querySelector(".input-tel").value.length;
  console.log(length)
  if (length >= 10) {
...
document.querySelector(".calculator-form__button").addEventListener("click", function(e) {
  ...
  const body = {
    "Стоимость автомобиля": form.querySelector(".cost-input").value,
    "Первоначальный взнос": form.querySelector(".installment-symm-input").value,
    "Срок лизинга": form.querySelector(".term-input").value,
    "Сумма договора лизинга": form.querySelector(".calculator-form__payment").innerText,
    "Ежемесячный платеж от": form.querySelector(".calculator-form__amount").innerText,
  }
      ...
      xhr.onreadystatechange = function () {
        ...
        if (xhr.readyState === 4) {
          if (xhr.status === 200) {
            ...
            document.querySelectorAll(".form-block-form__input").forEach(function(e) {
              e.value = ""
            })
            document.querySelectorAll(".form-label-done").forEach(function(e) {
              e.remove()
            })
            document.querySelector(".okay").classList.add("okay-visible")
            document.querySelector(".form-block-form__button").addEventListener("click", function() {
              document.body.style.overflow = "";
              formGreenshockAnimation.timeScale(2).reverse()
            })  
          }
...
costRangeSlider.noUiSlider.on('update', function (values, handle) {
  ...
  document.querySelector(".calculator-form__payment").innerHTML = Number(document.querySelector(".installment-symm-input").value) + Number(document.querySelector(".term-input").value) * parseInt(document.querySelector(".calculator-form__amount").innerHTML);
  // "₽"
  // Сумма договора лизинга
});

console.log(typeof Number(document.querySelector(".term-input").value))
