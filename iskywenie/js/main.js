...
window.onload = function () {
  ...
  if(e.target.closest(".burger-wrapper")) {
    document.querySelector(".burger-init").classList.toggle("burger-init-active")
  }
  if(!e.target.closest(".burger-init-active")) {
    document.querySelector(".burger-init").classList.remove("burger-init-active")
  }
})
